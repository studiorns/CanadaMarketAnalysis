...
const canadaData = {
    impressions: {
        '2023': [0, 0, 0, 25488124, 18191619, 14837498, 26196659, 23517126, 2410119, 16601945, 63187095, 22827750],
        '2024': [0, 0, 0, 25488124, 18191619, 14837498, 26196659, 23517126, 2410119, 16601945, 63187095, 22827750],
        '2025': [28537724, 17439720, 19323841, 9905487, 68410203, 34978936, 34978936, 26621120, 1547670, 2557020, 30776161, 22939881]
    },
    travelQueries: {
        '2023': [10.26, 9.87, 10.69, 9.26, 9.79, 10.18, 11.18, 11.57, 13.22, 17.45, 13.28, 13.32],
        '2024': [14.66, 12.50, 12.50, 11.14, 11.23, 10.84, 12.64, 13.09, 13.02, 16.74, 13.50, 13.24],
        '2025': {
            'moderate': [13.19, 11.56, 19.17, 17.44, 17.17, 16.94, 20.63, 20.50, 19.74, 32.95, 21.00, 21.20],
            'conservative': [13.19, 11.56, 17.80, 15.61, 15.49, 15.07, 18.89, 19.17, 18.61, 30.98, 19.82, 19.77],
            'ambitious': [13.19, 11.56, 20.60, 19.39, 18.94, 18.94, 22.46, 21.88, 20.89, 34.98, 22.20, 22.68]
        }
    },
    flightSearches: {
    ...
    queriesChart = new Chart(queriesCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: '2024 Actual',
                    data: canadaData.travelQueries['2024'],
                ...
                {
                    label: '2025 Moderate',
                    data: canadaData.travelQueries['2025']['moderate'],
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'Canada Travel Queries Forecast',
                    font: {
                        family: "'Inter', sans-serif",
                        size: 16,
                        weight: 'bold'
    ...
    impressionsChart = new Chart(impressionsCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: '2023',
                    data: canadaData.impressions['2023'],
                ...
                {
                    label: '2024',
                    data: canadaData.impressions['2024'],
                ...
                {
                    label: '2025 (Planned)',
                    data: canadaData.impressions['2025'],
                    borderColor: 'rgba(75, 192, 192, 1)',
                    backgroundColor: 'rgba(75, 192, 192, 0.1)',
                    borderWidth: 2,
                    fill: false
    ...
    flightsChart = new Chart(flightsCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: '2023',
                    data: canadaData.flightSearches['2023'],
                    borderColor: 'rgba(54, 162, 235, 1)',
                    backgroundColor: 'rgba(54, 162, 235, 0.1)',
                    borderWidth: 2,
                    fill: false
                ...
                {
                    label: '2024',
                    data: canadaData.flightSearches['2024'],
                    borderColor: 'rgba(255, 159, 64, 1)',
                    backgroundColor: 'rgba(255, 159, 64, 0.1)',
                    borderWidth: 2,
                    fill: false
    ...
    hotelChart = new Chart(hotelCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: '2023',
                    data: canadaData.hotelGuests['2023'],
                    borderColor: 'rgba(54, 162, 235, 1)',
                    backgroundColor: 'rgba(54, 162, 235, 0.1)',
                    borderWidth: 2,
                    fill: false
...
function updateQueriesChart(scenario) {
    ...
    if (scenario === 'actual') {
        ...
        queriesChart.data.datasets.push({
            label: '2023 Actual',
            data: canadaData.travelQueries['2023'],
            borderColor: 'rgba(54, 162, 235, 1)',
            backgroundColor: 'rgba(54, 162, 235, 0.1)',
            borderWidth: 2,
            fill: false
        ...
        queriesChart.data.datasets.push({
            ...
            data: canadaData.travelQueries['2025'][scenario],
            borderColor: 'rgba(75, 192, 192, 1)',
            backgroundColor: 'rgba(75, 192, 192, 0.1)',
            borderWidth: 2,
            fill: false
